...
$result = mysqli_query($connection, $get_nationalities);
if (!$result) {
...
<body>
    ...
    <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
        ...
        <div class="mt-8 bg-white p-4 shadow rounded-lg nationalities-table">
            <div class="flex justify-between items-center">
                <h2 class="text-gray-500 text-lg font-semibold pb-4">Clubs table</h2>

                <button class="bg-cyan-500 hover:bg-cyan-600 text-white font-semibold py-2 px-4 rounded "
                    id="show-form-nationality">
                    Add Club
                </button>
            </div>
                        ...
                        <tr class="hover:bg-grey-lighter">
                            ...
                            <td class="text-center py-2 px-4 border-b border-grey-light">
                                <div class="flex justify-center">
                                    <img src="../../assets/img/clubs/<?= $club['flag_image']; ?>" alt="Foto Perfil" class="rounded-full h-10 w-10">
                            ...
                            <td class="text-center flex justify-center py-2 px-4 border-b border-grey-light">
                                <div class="flex">
                                    <a href="updateclub.php?action=update&id=<?php echo $club['nationality_id']; ?>" id="delete"
                                        name="delete">
        ...
        <div id="nationality_form" class="flex justify-center hidden">
    ...
    <script>
    const table = document.querySelector(".nationalities-table");
    const countryForm = document.getElementById("nationality_form");
        const getCountryForm = document.getElementById("show-form-nationality")
