                        ...
                        <div class="flex flex-col gap-8 my-2">
                            <div class="flex items-center">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <label for="profile-img"
                                        class="cursor-pointer bg-primary text-white py-1 px-2 rounded">
                                        Select Image
                                    </label>
                                </div>
                            ...
                            <div class="flex">
                                <div class="flex flex-col">
                                    ...
                                    <select name="position" id="position" class="p-2 w-80 rounded" name="position">
                            ...
                            <div class="flex">
                                <div class="flex flex-col">
                                    ...
                                    <select name="club" id="club" class="p-2 w-80 rounded">
